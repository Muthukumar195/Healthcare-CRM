...
import { loadingButton, resetPasswordValidation, ToastError, ToastSuccess } from "../../../components";
import { patientResetPassword } from "../../../redux/actions/auth/loginActions";
                  ...
                  <CardBody className="pt-1 pb-0">
                    <Formik
                      ...
                      onSubmit={(values, actions) => {
                        ...
                        this.props.patientResetPassword(values);
                      }}
...
export default connect(mapStateToProps, { patientResetPassword })(PatientResetPassword);
