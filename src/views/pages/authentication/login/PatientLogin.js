...
import { plogin } from "../../../../redux/actions/auth/loginActions";
...
class PatientLogin extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (this.props.authentication != prevProps.authentication) {
      if (!this.props.authentication.status) {
        ToastError(this.props.authentication.message)
  ...
  render() {
    return (
      <React.Fragment>
        <div className="custom-navbar-dark">
            ...
            <Card className="bg-authentication login-card rounded-0 w-100">
              <Row className="m-0">
                ...
                <Col lg="6" md="12" className="p-0">
                  <Card className="rounded-0 mb-0 pl-4 pr-4 pt-5 pb-2">
                    <CardBody>
                      <h4>Patient Login</h4>
                      ...
                      >
                        {({ errors, values, setFieldValue, touched, isSubmitting, getFieldProps }) => (
                          <Form>
                            ...
                            <Row>
                              ...
                              <Col md="6" sm="6" xs="6" className="text-right">
                                <div
                                  ...
                                  onClick={() => history.push("/patient-forgot-password")}
                                >
                                  Forgot Password?
                              </div>
                              </Col>
                            ...
                            <Row>
                              <Col md="6" sm="6" xs="6">
                                <div className="cursor-pointer help-link">
                                  <a href={config.webBaseUrl + '/technical-support'} target="_blank">Need Help?</a>
                                </div>
                              </Col>
                              <Col md="6" sm="6" xs="6" >
                                <div className="cursor-pointer text-right help-link">
...
export default connect(mapStateToProps, { plogin })(PatientLogin);
